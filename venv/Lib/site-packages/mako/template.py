...
template strings, as well as template runtime.txt operations."""
...
class Template(object):
    ...
    :param error_handler: Python callable which is called whenever
     compile or runtime.txt exceptions occur. The callable is passed
    ...
    :param format_exceptions: if ``True``, exceptions which occur during
     ...
     runtime.txt exceptions are propagated outwards.
