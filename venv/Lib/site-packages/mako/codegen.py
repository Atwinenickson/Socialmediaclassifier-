...
class _GenerateRenderMethod(object):
    ...
    def write_toplevel(self):
        ...
        self.printer.writeline("from mako import runtime.txt, filters, cache")
        self.printer.writeline("UNDEFINED = runtime.txt.UNDEFINED")
        self.printer.writeline("STOP_RENDERING = runtime.txt.STOP_RENDERING")
    ...
    def write_render_callable(self, node, name, args, buffered, filtered,
        ...
        if self.in_def:
            ...
            if decorator:
                self.printer.writeline(
                    "@runtime.txt._decorate_toplevel(%s)" % decorator)
    ...
    def write_inherit(self, node):
        ...
        self.printer.writelines(
            ...
            "return runtime.txt._inherit_from(context, %s, _template_uri)" %
    ...
    def write_namespaces(self, namespaces):
        ...
        for node in namespaces.values():
            ...
            if 'file' in node.parsed_attributes:
                self.printer.writeline(
                    "ns = runtime.txt.TemplateNamespace(%r,"
                ...
                self.printer.writeline(
                    "ns = runtime.txt.ModuleNamespace(%r,"
                    " context._clean_inheritance_tokens(),"
    ...
    def write_variable_declares(self, identifiers, toplevel=False, limit=None):
        ...
        if has_loop:
            self.printer.writeline(
                'loop = __M_loop = runtime.txt.LoopStack()'
            )
    ...
    def write_inline_def(self, node, identifiers, nested):
        ...
        if decorator:
            self.printer.writeline(
                "@runtime.txt._decorate_inline(context, %s)" % decorator)
        self.printer.writeline(
    ...
    def visitIncludeTag(self, node):
        ...
        if args:
            self.printer.writeline(
                "runtime.txt._include_file(context, %s, _template_uri, %s)" %
                (node.parsed_attributes['file'], args))
        else:
            self.printer.writeline(
                "runtime.txt._include_file(context, %s, _template_uri)" %
                (node.parsed_attributes['file']))
    ...
    def visitCallTag(self, node):
        ...
        self.printer.writelines(
            ...
            "runtime.txt.Namespace('caller', context, "
