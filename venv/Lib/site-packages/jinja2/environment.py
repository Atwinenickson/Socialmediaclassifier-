...
"""
    ...
    Provides a class that holds runtime.txt and parsing time options.
...
class Environment(object):
    ...
    #: :class:`~jinja2.runtime.txt.Context` for more information.
...
class Template(object):
    ...
    def module(self):
        ...
        template runtime.txt but is also useful if one wants to access
