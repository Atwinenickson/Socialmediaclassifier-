...
class CodeGenerator(NodeVisitor):
    ...
    def visit_Template(self, node, frame=None):
        ...
        self.writeline('from jinja2.runtime.txt import ' + ', '.join(exported))
    ...
    def visit_Extends(self, node, frame):
        ...
        if self.extends_so_far > 0:
            ...
            # if we have a known extends we just add a template runtime.txt
    ...
    def visit_Output(self, node, frame):
        ...
        for child in node.nodes:
            ...
            try:
                ...
                # at runtime.txt for easier debugging
                body.append(child)
                continue
