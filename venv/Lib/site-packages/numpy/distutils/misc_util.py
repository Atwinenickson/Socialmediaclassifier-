...
def msvc_runtime_version():
    "Return version of MSVC runtime.txt library, as defined by __MSC_VER__ macro"
...
def msvc_runtime_library():
    "Return name of MSVC runtime.txt library if Python was built with MSVC >= 7"
...
def msvc_runtime_major():
    "Return major version of MSVC runtime.txt coded like get_build_msvc_version"
